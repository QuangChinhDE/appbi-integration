...
(
    'Request_Complete_GDrive_20260401',
    '{"app": "request", "app_name": "Request", "domain": "base.vn", "access_token_hash": "$2b$12$demo_hash_value"}',
    'all',
    '{"type": "gdrive", "name": "Google Drive", "auth": {"email": "demo@gmail.com"}}',
    '{"objects": ["group", "request"]}',
    '{"type": "daily", "time": "02:00", "enabled": true}',
    'active',
    0,
    1,
    'demo_user'
...
(
    'Workflow_Structured_GSheets_20260315',
    '{"app": "workflow", "app_name": "Workflow", "domain": "base.vn", "access_token_hash": "$2b$12$demo_hash_value"}',
    'structured',
    '{"type": "gsheets", "name": "Google Sheets", "auth": {"email": "demo@gmail.com"}}',
    '{"objects": ["workflow", "job"], "custom_fields": ["wf1", "wf2"]}',
    '{"type": "weekly", "day_of_week": 1, "time": "01:00", "enabled": true}',
    'active',
    0,
    1,
    'demo_user'
