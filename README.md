...
For Google sign-in: `AUTH_GOOGLE_ENABLED`, `AUTH_GOOGLE_CLIENT_ID`, `AUTH_GOOGLE_ALLOWED_DOMAINS`, `AUTH_GOOGLE_AUTO_CREATE_USERS`, `VITE_AUTH_GOOGLE_ENABLED`, `VITE_GOOGLE_CLIENT_ID`

For Google data-access features: `GOOGLE_CLIENT_ID`, `GOOGLE_CLIENT_SECRET`, `GOOGLE_REDIRECT_URI`
