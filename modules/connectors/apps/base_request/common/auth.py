...
from modules.connectors.apps.base_request.common.constants import API_PREFIX


def normalize_request_domain(domain: str) -> str:
...
class RequestCredentials(BaseModel):
    ...
    def validate_domain(cls, value: str) -> str:
        return normalize_request_domain(value)
    ...
    def base_url(self) -> str:
        return f"https://request.{self.domain}{API_PREFIX}"