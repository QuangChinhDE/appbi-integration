...
from modules.connectors.apps.base_wework.common.constants import API_PREFIX


def normalize_wework_domain(domain: str) -> str:
    ...
    if cleaned.startswith("wework."):
        cleaned = cleaned[len("wework.") :]
...
class WeworkCredentials(BaseModel):
    ...
    def validate_domain(cls, value: str) -> str:
        return normalize_wework_domain(value)
    ...
    def base_url(self) -> str:
        return f"https://wework.{self.domain}{API_PREFIX}"