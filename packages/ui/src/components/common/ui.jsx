...
export const Modal = ({ open, onCancel, title, children, footer, width = 520, className = '' }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        className={`relative flex max-h-[90vh] flex-col rounded-xl border border-gray-200 bg-white shadow-xl ${className}`}
      ...
      >
        ...
        {footer && (
          <div className="flex items-center justify-end gap-2 border-t border-gray-200 bg-gray-50 px-6 py-3 shrink-0">
            {footer}
          </div>
        )}
      </div>
