...
export function DetailBody({
  ...
  children: React.ReactNode;
  /**
   * Size to the content instead of claiming the leftover height.
   *
   * For a page whose body is a short summary and whose *point* is something
   * below it -- the execution detail, where four meta tiles sat above a run
   * panel and the two split the screen between them, leaving a few hundred
   * pixels of nothing in the middle and squeezing the data nobody opened the
  ...
  return (
    <div
      className={cn(
        'flex min-h-0 flex-col px-4 py-5 sm:px-6 xl:px-8',
